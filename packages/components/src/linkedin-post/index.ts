...
export type { LinkedInPostProps, LinkedInPostCss, LinkedInPostData, LinkedInPostAuthor, LinkedInPostMedia, LinkedInPostLinkPreview, LinkedInPostStats } from './schema';
