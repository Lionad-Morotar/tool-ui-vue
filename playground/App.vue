...
function GalleryCard(props: { card: ComponentCard; class?: string }) {
  return h(
    ...
    {
      class: cn(
        "group/gallery-card relative flex items-center justify-center w-full min-w-0 max-w-full flex-col gap-3 overflow-hidden rounded-xl bg-card/40 p-3 pb-5 shadow-sm transition-[background-color,box-shadow] duration-200 hover:bg-card/80 focus-within:bg-card/80 break-inside-avoid mb-5",
        props.class
      ),
    },
    [
