...
<template>
  ...
  >
    <div class="bg-card/60 border-border flex w-full flex-col gap-4 rounded-2xl border p-5 shadow-xs">
      <div class="flex items-center justify-between">
        <!-- Elapsed Time -->
        <div v-if="elapsedTime" class="text-muted-foreground flex items-center gap-1.5 font-mono text-xs">
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="-mt-px size-3.5">
        ...
        <span :class="cn('flex items-center gap-1.5 text-xs font-medium', receiptState.toneClass)">
          <svg v-if="receiptState.icon === 'check'" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-3.5">
            <path d="M20 6 9 17l-5-5"/>
          </svg>
          <svg v-else-if="receiptState.icon === 'alert'" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-3.5">
            <circle cx="12" cy="12" r="10"/>
            <line x1="12" x2="12" y1="8" y2="12"/>
            <line x1="12" x2="12.01" y1="16" y2="16"/>
          </svg>
          <svg v-else xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-3.5">
            <path d="M18 6 6 18"/>
            <path d="m6 6 12 12"/>
          </svg>
          {{ choice.summary }}
      ...
      <ol class="m-0 flex list-none flex-col gap-2 p-0">
        ...
        >
          <div
            ...
            class="bg-border absolute top-8 left-5 w-px"
          ...
          <div class="relative z-10">
            ...
            <span
              ...
              class="bg-card border-border flex size-6 shrink-0 items-center justify-center rounded-full border motion-safe:transition-all motion-safe:duration-200"
              aria-hidden="true"
            />
            <!-- In Progress -->
            <span
              v-else-if="step.status === 'in-progress'"
              class="bg-card border-border flex size-6 shrink-0 items-center justify-center rounded-full border shadow-[0_0_0_4px_hsl(var(--primary)/0.1)] motion-safe:transition-all motion-safe:duration-300"
              aria-hidden="true"
            >
            ...
            <span
              ...
              class="bg-primary text-primary-foreground border-primary flex size-6 shrink-0 items-center justify-center rounded-full border shadow-sm motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 motion-safe:duration-300 motion-safe:ease-out"
              aria-hidden="true"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="size-4 motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 motion-safe:delay-75 motion-safe:duration-200 motion-safe:fill-mode-both">
                <path d="M20 6 9 17l-5-5"/>
              </svg>
            </span>
            <!-- Failed -->
            <span
              ...
              class="bg-destructive border-destructive flex size-6 shrink-0 items-center justify-center rounded-full border text-white shadow-sm motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 motion-safe:duration-300 motion-safe:ease-out dark:border-red-600 dark:bg-red-600"
              aria-hidden="true"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="size-4 motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-75 motion-safe:delay-75 motion-safe:duration-200 motion-safe:fill-mode-both">
                <path d="M18 6 6 18"/>
          ...
          <div class="flex flex-1 flex-col gap-0.5">
            ...
            <span v-if="step.description" class="text-muted-foreground text-sm">{{ step.description }}</span>
          </div>
        </li>
      </ol>
    </div>
  ...
  >
    <div class="bg-card border-border flex w-full flex-col gap-4 rounded-2xl border p-5 shadow-xs">
      <!-- Elapsed Time -->
      <div v-if="elapsedTime" class="text-muted-foreground flex items-center gap-1.5 font-mono text-xs">
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="-mt-px size-3.5">
          <line x1="10" x2="14" y1="2" y2="2"/>
            ...
            <div class="flex flex-1 flex-col">
              ...
              >
                <div class="overflow-hidden">
                  <span class="text-muted-foreground block pt-0.5 text-sm">
                    {{ step.description }}
                  </span>
                </div>
              </div>
