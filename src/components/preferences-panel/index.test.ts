...
describe("PreferencesPanel", () => {
  ...
  describe("interactions - switch", () => {
    test("toggles switch and emits change", async () => {
      ...
      expect((wrapper.emitted("change")![0] as any)[0]).toMatchObject({ notifications: false });
    });
  ...
  describe("interactions - toggle", () => {
    test("selects toggle option and emits change", async () => {
      ...
      expect(wrapper.emitted("change")).toBeTruthy();
      expect((wrapper.emitted("change")![0] as any)[0]).toMatchObject({ theme: "dark" });
    });
  ...
  describe("interactions - select", () => {
    test("changes select and emits change", async () => {
      ...
      expect(wrapper.emitted("change")).toBeTruthy();
      expect((wrapper.emitted("change")![0] as any)[0]).toMatchObject({ language: "es" });
    });
  ...
  describe("actions", () => {
    test("emits action on save click after making a change", async () => {
      ...
      expect((wrapper.emitted("action")![0] as any)[0]).toBe("save");
    });
    ...
    test("emits action on cancel click", async () => {
      ...
      expect(wrapper.emitted("action")).toBeTruthy();
      expect((wrapper.emitted("action")![0] as any)[0]).toBe("cancel");
    });
    ...
    test("emits beforeAction before action", async () => {
      ...
      expect((wrapper.emitted("beforeAction")![0] as any)[0]).toBe("save");
    });
    ...
    test("supports custom actions", async () => {
      ...
      expect((wrapper.emitted("action")![0] as any)[0]).toBe("apply");
    });
    ...
    test("cancel resets values to initial", async () => {
      ...
      const lastChangeEvent = (wrapper.emitted("change")!.pop() as any)[0];
