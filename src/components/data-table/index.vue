  ...
  >
    ...
    <div :class="tableContainerClass">
      <div class="relative">
        <div
          :class="cn(
            'bg-card border-border relative w-full overflow-hidden overflow-y-auto rounded-lg border',
            'touch-pan-x',
              ...
              <thead class="[&_tr]:border-b">
                <tr class="hover:bg-transparent">
                  <th
                    ...
                    scope="col"
                    :class="cn(
                      'h-10 align-middle font-normal text-muted-foreground whitespace-nowrap',
                  ...
                  >
                    ...
                    <template v-else-if="column.format?.kind === 'link'">
                      <a
                        ...
                        class="text-primary inline-block max-w-full break-words underline underline-offset-2 hover:opacity-90"
                    ...
                    <template v-else-if="column.format?.kind === 'array'">
                      <span class="inline-flex flex-wrap items-center gap-1">
                        <span
                          ...
                          :key="i"
                          class="bg-muted text-muted-foreground inline-flex items-center rounded-md px-2 py-0.5 text-xs"
                        >
    ...
    >
      ...
      <div v-if="data.length === 0" class="text-muted-foreground py-8 text-center">
        {{ emptyMessage || "No data available" }}
      </div>

      <div
        v-else
        class="bg-card border-border flex flex-col overflow-hidden rounded-2xl border shadow-xs"
      >
        <div
          v-for="(row, index) in sortedData"
          :key="getRowId(row, index)"
            ...
            >
              <div class="flex min-w-0 flex-1 flex-col gap-2">
                ...
                <div
                  ...
                  class="text-muted-foreground flex w-full flex-wrap gap-x-4 gap-y-0.5"
                >
                  <span
